 ...
 * @param A1
 */
Gs47SerialSRAM::Gs47SerialSRAM(PinName sda, PinName scl, PinName hs, const uint8_t A2, const uint8_t A1) : i2c (sda, scl) {
    //build mask
 ...
 * @return
 */
uint8_t Gs47SerialSRAM::read(char *buffer) {
 ...
 * @return
 */
uint8_t Gs47SerialSRAM::read(const uint16_t address, char *buffer) {
 ...
 * @return
 */
uint8_t Gs47SerialSRAM::read(const uint16_t address, char *buffer, const uint16_t size) {
 ...
 * @return
 */
uint8_t Gs47SerialSRAM::write(const uint16_t address, const uint8_t data) {
 ...
 * @return
 */
uint8_t Gs47SerialSRAM::write(const uint16_t address, const char *data, const uint16_t size) {
 ...
 * @return
 */
uint8_t Gs47SerialSRAM::readControlRegister(char *buffer) {
 ...
 * @return
 */
uint8_t Gs47SerialSRAM::writeControlRegister(const uint8_t address, const uint8_t value) {
...
uint8_t Gs47SerialSRAM::getAutoStore() {
 ...
 */
void Gs47SerialSRAM::setAutoStore(const uint8_t value) {
    static char buffer = 0x00;
